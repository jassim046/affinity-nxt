      ...
      <div className="row mil-services-grid m-0">
        ...
        <div className="col-md-6 col-lg-2-5 mil-services-grid-item p-0">
          <div className="mil-service-card-sm mil-up">
            ...
            <p className="mil-light-soft mil-mb-30">
              A NAAC-focused ERP for colleges, enabling effortless data entry,
              streamlined documentation, and compliance-ready reporting for
        ...
        <div className="col-md-6 col-lg-2-5 mil-services-grid-item p-0">
          <div className="mil-service-card-sm mil-up">
            ...
            <p className="mil-light-soft mil-mb-30">
              A hybrid mobile app for colleges to record, track, and report
              student attendance class-wise and hour-wise, with FYUG support
        ...
        <div className="col-md-6 col-lg-2-5 mil-services-grid-item p-0">
          <div className="mil-service-card-sm mil-up">
            ...
            <p className="mil-light-soft mil-mb-30">
              A simple, secure fee collection platform for schools and colleges,
              offering online payments, automated receipts, and real-time reporting.
            </p>
          </div>
        </div>
        ...
        <div className="col-md-6 col-lg-2-5 mil-services-grid-item p-0">
          <div className="mil-service-card-sm mil-up">
            ...
            <p className="mil-light-soft mil-mb-30">
              A web app for temples that enables devotees to book offerings
              online with secure payments, multi-deity support, and
