...
export default function HomeContent() {
  ...
  return (
    <>
      ...
      {/* Solutions Section */}
      <section className="mil-dark-bg mil-p-80-0">
        <div className="container">
          <div className="mil-mb-30 text-center">
            <h2 className="mil-h1 mil-muted">Our <span className="mil-thin">Solutions</span></h2>
          </div>
          <div className="row mil-services-grid m-0">
            <div className="col-md-6 col-lg-2-5 mil-services-grid-item p-0">
              <div className="mil-service-card-sm mil-up">
                <div className="ai-partner-logo mil-mb-30"><img src="/img/solution/1.png" className="img-fluid" alt="NAAC ERP" /></div>
                <p className="mil-light-soft mil-mb-30">A NAAC-focused ERP for colleges, enabling effortless data entry and compliance-ready reporting.</p>
              </div>
            </div>
            <div className="col-md-6 col-lg-2-5 mil-services-grid-item p-0">
              <div className="mil-service-card-sm mil-up">
                <div className="ai-partner-logo mil-mb-30"><img src="/img/solution/2.png" alt="Attendance App" /></div>
                <p className="mil-light-soft mil-mb-30">A hybrid mobile app for colleges to track student attendance class-wise and hour-wise.</p>
              </div>
            </div>
            <div className="col-md-6 col-lg-2-5 mil-services-grid-item p-0">
              <div className="mil-service-card-sm mil-up">
                <div className="ai-partner-logosolution mil-mb-30"><img src="/img/solution/3.png" alt="Fee Collection" /></div>
                <p className="mil-light-soft mil-mb-30">A simple, secure fee collection platform for schools, offering online payments and automated receipts.</p>
              </div>
            </div>
            <div className="col-md-6 col-lg-2-5 mil-services-grid-item p-0">
              <div className="mil-service-card-sm mil-up">
                <div className="ai-partner-logo mil-mb-30"><img src="/img/solution/4.png" alt="Logistics Tracking" /></div>
                <p className="mil-light-soft mil-mb-30">A web app for logistics companies that lets customers track consignments in real time with ease.</p>
              </div>
            </div>
            <div className="col-md-6 col-lg-2-5 mil-services-grid-item p-0">
              <div className="mil-service-card-sm mil-up">
                <div className="ai-partner-logo mil-mb-30"><img src="/img/solution/5.png" alt="Temple Booking" /></div>
                <p className="mil-light-soft mil-mb-30">A web app for temples that enables devotees to book offerings online with secure payments.</p>
              </div>
            </div>
          </div>
        </div>
